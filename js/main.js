  ...
  $(document).ready(function() {
    ...
    if ($("#instafeed-gallery").length) {
      var galleryFeed = new Instafeed({
        get: "user",
        userId: 5688905656,
        accessToken: "5688905656.1677ed0.c49904aa79ea4ada82a5833d293c69a5",
    ...
    function initialize() {
      var map;
      var panorama;
      var var_latitude = 40.618570; // Google Map Latitude
      var var_longitude = 40.303536; // Google Map Longitude
      var pin = 'images/icons/pin.svg';

      //Map pin-window details
      var title = "Uzungöl İnanlar Hotel - Görüntülemek için tıklayın.";
      var hotel_name = "Uzungöl İnanlar Hotel";
      var hotel_address = "Uzungöl Mah. Fatih Cad. Çaykara Trabzon";
      var hotel_desc = "Uzungöl İnanlar Hotel & Restaurant";
      var hotel_more_desc = "Uzungöl İnanlar Hotel & Resturant Bungalow";
      ...
      var contentString =
        ...
        '<p><strong>' + hotel_name + 'İnanlar Hotel & Restaurant' +
        hotel_address + '<br>' +
        hotel_desc + '<br>' +
        hotel_more_desc + '</p>' +
        '</div>';
